...
bucket_config = {  # 12s/it
    "128": {1: (1.0, 475), 8: (1.0, 51), 9: ((1.0, 0.33), 27), 10: ((1.0, 0.1), 13), 11: ((1.0, 0.1), 6)},
    "144p": {1: (1.0, 475), 2: (1.0, 51), 4: ((1.0, 0.33), 27), 6: ((1.0, 0.1), 13), 8: ((1.0, 0.1), 6)},
    # ---
    "256": {1: (0.4, 297), 2: (0.5, 20), 4: ((0.5, 0.33), 10), 6: ((0.5, 0.1), 5), 8: ((0.5, 0.1), 2)},
